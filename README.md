...
The video generation model has not been completed till now, when the v1.0 is being released. Also the plotting on abstract surfaces has not been implemented yet. They are to be integrated via an agentic-modular AI that could take raw inputs and data rather than heavy scientific language, which could make the work easier.